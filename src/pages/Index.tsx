...
export default function Index() {
  ...
  return (
    <div className="flex h-full w-96 max-w-full flex-col px-1 md:w-[1008px]">
      ...
      <section className="templateSection flex w-full flex-col items-center justify-center gap-4 rounded-xl px-2 py-4 md:grow bg-[url('/cloud-background.jpg')] bg-cover bg-center bg-no-repeat">
